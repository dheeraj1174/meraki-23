...
export const getEmailTemplate = (title: string, otp: string) => `
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 22px; font-weight: 400;">Meraki</h1>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      <a href="https://meraki-23.vercel.app" target="_blank">
      <img align="center" border="0" src="https://meraki-23.vercel.app/images/transparent-logo.png" alt="" title="Meraki Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 55%;max-width: 80.67px;" width="80.67"/>
      </a>
    </td>
  </tr>
</table>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 18px; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="line-height: 140%;">Your OTP is <strong>${otp}</strong></p>
  </div>
...
<p style="line-height: 140%;">For any queries: contact: <a rel="noopener" href="mailto:meraki@iiitu.ac.in?subject=Query%20Regarding%20Meraki%20Technical%20Fest%20of%20IIIT%20Una" target="_blank">meraki@iiitu.ac.in</a></p>
  </div>
...
export const sendRegistrationOtp = async (to: string, otp: string) => {
	try {
		const title =
			"Welcome to Meraki - Annual Techfest of IIIT Una. Verify your email";
		const html = getEmailTemplate("Verify your email", otp);
...
export const sendPasswordResetOtp = async (to: string, otp: string) => {
	try {
		...
		const html = getEmailTemplate(title, otp);
		await sendEmail(to, title, html);
	} catch (error: any) {
		console.error(error);
	}
